...
>|----------|----------------|------|
>| VDD      | 3.3V           | 仅接 3.3V，勿接 5V |
>| LEDA     | 3.3V           | 背光正极，建议串 100–220Ω 限流或遵从模块板载电阻 |
>| LEDK     | GND（默认） | 背光负极，直接接地即可常亮 |
>| SCL      | GPIO 12（SCLK）| SPI 时钟 |
>| SDA      | GPIO 11（MOSI）| SPI 数据 |
>| D/C      | GPIO 9         | 数据/命令 |
>| CS       | GPIO 10        | 独立片选，避免与 SD 总线冲突 |
>| RESET    | GPIO 8         | 复位 |
>| GND×3    | GND            | 多个地脚任选其一，推荐都接地 |
